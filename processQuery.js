...
const getDomText_1 = __importDefault(require("./getDomText"));
const search_1 = require("./search");
const utils_1 = require("./utils");
async function processQuery(response, prevData, documents, ignoreIds = []) {
    try {
        ...
        if (internetSearchMatch) {
            const allResults = (await (0, search_1.search)(searchQuery)).webPages.value;
            ...
            if (prevData.type === 'internet') {
                ...
                const text = await (0, getDomText_1.default)(res);
